                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildTextField('Salário R\$',
                                  _solicPostController.controllerSalario, false,
                                  validateTextField: _validateTextField),
                              SizedBox(
                                height: 20,
                              ),
                              _buildTextField('Líquido (Contra-Cheque) R\$',
                                  _solicPostController.controllerLiquido, false,
                                  validateTextField: _validateTextField),
                              SizedBox(
                                height: 20,
                              ),
                              _buildTextField('Pensão Alimentícia R\$',
                                  _solicPostController.controllerPensao, false),
                              SizedBox(
                                height: 20,
                              ),
                              _buildTextField(
